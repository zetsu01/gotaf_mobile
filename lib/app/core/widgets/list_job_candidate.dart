...
class ListJobCandidateWidget extends StatelessWidget {
  const ListJobCandidateWidget({Key? key}) : super(key: key);
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              height: 20,
                              width: 20,
                              child: svgParser(iconCatNettoyage, 'iconCatNettoyage'),
                            ),
                            Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            '100',
                            style: Theme.of(context).textTheme.headline6?.copyWith(
                                  color: GotafColors.secondaryDark,
                                  fontSize: 11,
                                  fontWeight: FontWeight.bold,
                                ),
                          ),
